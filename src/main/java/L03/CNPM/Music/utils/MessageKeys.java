...
public class MessageKeys {
    ...
    public static final String UPLOAD_IMAGES_FILE_LARGE = "Image file size exceeds the allowed limit of 10MB.";
    public static final String UPLOAD_IMAGES_FILE_MUST_BE_IMAGE = "Image file is required.";
    public static final String UPLOAD_IMAGES_SUCCESSFFULLY = "User Profile Image is updated succesfully.";
    ...
    public static final String WRONG_EMAIL = "user.login.wrong_email";
    ...
    public static final String USER_EXISTED = "User not found";
    public static final String CLOUDINARY_UPLOAD_FAIL = "Upload to Cloudinary Fail, please try again!";
